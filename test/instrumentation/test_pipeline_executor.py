...
def test_black_box_operation():
    ...
    test_code = cleandoc("""
        import pandas
        from mlidea.testing._testing_helper_utils import black_box_df_op
...
def test_instrument_pipeline_with_code_reference_tracking():
    ...
    expected_code = cleandoc("""
            from mlidea.execution._pipeline_executor import set_code_reference_call, set_code_reference_subscript, monkey_patch, undo_monkey_patch
            monkey_patch()
            import pandas as pd
