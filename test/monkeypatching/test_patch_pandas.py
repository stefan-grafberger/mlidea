...
def test_read_parquet():
    ...
    expected_node = DagNode(0,
                            ...
                            OperatorContext(OperatorType.DATA_SOURCE,
                                            FunctionInfo('pandas.io.parsers', 'read_parquet'), Comparison(dict)),
...
def test_frame__getitem__selection():
    ...
    expected_subscript = DagNode(2,
                                 ...
                                 OperatorContext(OperatorType.SUBSCRIPT,
                                                 FunctionInfo('pandas.core.series', '_cmp_method'), Comparison(dict)),
...
def test_frame__setitem__():
    ...
    expected_subscript = DagNode(2,
                                 BasicCodeLocation('<string-source>', 7),
                                 OperatorContext(OperatorType.SUBSCRIPT,
                                                 FunctionInfo('pandas.core.series', '_arith_method'), Comparison(dict)),
...
def test_frame_replace():
    ...
    expected_modify = DagNode(1,
                              BasicCodeLocation("<string-source>", 4),
                              OperatorContext(OperatorType.PROJECTION_MODIFY,
                                              FunctionInfo('pandas.core.frame', 'replace'), Comparison(dict)),
...
def test_to_dict_default():
    ...
    expected_groupby_agg = DagNode(1,
                                   BasicCodeLocation("<string-source>", 4),
                                   OperatorContext(OperatorType.PROJECTION,
                                                   FunctionInfo('pandas.core.frame', 'to_dict'), Comparison(dict)),
...
def test_series_isin():
    ...
    expected_isin = DagNode(1,
                            BasicCodeLocation("<string-source>", 4),
                            OperatorContext(OperatorType.SUBSCRIPT,
                                            FunctionInfo('pandas.core.series', 'isin'), Comparison(dict)),
...
def test_series_astype():
    ...
    expected_astype = DagNode(1,
                              BasicCodeLocation("<string-source>", 4),
                              OperatorContext(OperatorType.SUBSCRIPT,
                                              FunctionInfo('pandas.core.series', 'astype'), Comparison(dict)),
...
def test_frame_fillna():
    ...
    expected_astype = DagNode(1,
                              BasicCodeLocation("<string-source>", 4),
                              OperatorContext(OperatorType.PROJECTION_MODIFY,
                                              FunctionInfo('pandas.core.frame', 'fillna'), Comparison(dict)),
...
def test_series_fillna():
    ...
    expected_astype = DagNode(1,
                              BasicCodeLocation("<string-source>", 4),
                              OperatorContext(OperatorType.PROJECTION_MODIFY,
                                              FunctionInfo('pandas.core.series', 'fillna'), Comparison(dict)),
                              DagNodeDetails('fillna: 0.0', ['A'], OptimizerInfo(RangeComparison(0, 200), (4, 1),
                                                                                 RangeComparison(0, 800))),
                              OptionalCodeInfo(CodeReference(4, 11, 4, 32),
...
def test_series_replace():
    ...
    expected_replace = DagNode(1,
                               BasicCodeLocation("<string-source>", 4),
                               OperatorContext(OperatorType.PROJECTION_MODIFY,
                                               FunctionInfo('pandas.core.series', 'replace'), Comparison(dict)),
...
def test_series__invert__():
    ...
    expected_subscript = DagNode(1,
                                 BasicCodeLocation("<string-source>", 3),
                                 OperatorContext(OperatorType.SUBSCRIPT,
                                                 FunctionInfo('pandas.core.series', '__invert__'), Comparison(dict)),
                                 DagNodeDetails('~', ['A'], OptimizerInfo(RangeComparison(0, 200), (4, 1),
                                                                          RangeComparison(0, 800))),
...
def test_series_str_len():
    ...
    expected_isin = DagNode(1,
                            BasicCodeLocation("<string-source>", 4),
                            OperatorContext(OperatorType.SUBSCRIPT,
                                            FunctionInfo('pandas.core.strings.StringMethods', 'len'), Comparison(dict)),
