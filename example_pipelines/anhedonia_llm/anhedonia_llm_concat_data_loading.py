...
user_locations = [
    f'{str(get_project_root())}/example_pipelines/anhedonia_ml/data/users.pqt',
    f'{str(get_project_root())}/example_pipelines/anhedonia_ml/data/users_copy.pqt'
]

tweet_location = f'{str(get_project_root())}/example_pipelines/anhedonia_ml/data/tweets.pqt'
included_countries = ['NL']
