...
from mlidea.analysis._data_corruption import CorruptionType, CORRUPTION_FUNCS_FOR_CORRUPTION_TYPES
...
class DataCorruptionWithModelVariants(WhatIfAnalysis):
    ...
    def __init__(self,
                 column_to_corruption: dict[str, FunctionType | CorruptionType],
