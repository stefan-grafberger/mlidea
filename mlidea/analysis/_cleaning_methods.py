...
class OutlierCleaner:
    ...
    def fit_transform_all(input_df, detection_strategy, repair_strategy, column):
        ...
        if detection_strategy == 'SD':
            ...
            raise ValueError(f"Unknown outlier detection strategy: {detection_strategy}!")
        ...
        fitted_imputer = fixed_data_with_fitted_imputer._mlinspect_annotation
    ...
    def transform_all(fit_data, input_df, column):
        ...
        annotation = fit_data._mlinspect_annotation
    ...
    def fit_cleanlab(train_data, train_labels, make_classifier_func):
        ...
        if isinstance(train_labels, pandas.Series):
            ...
            if train_labels.shape[1] != 1:
                raise NotImplementedError("TODO: Think about this edge case! "
                                          "Cleanlab documentation: 'labels must be integers in 0, 1, …, K-1, where K "
