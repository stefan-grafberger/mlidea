...
from mlidea import OperatorType, DagNode, OperatorContext, DagNodeDetails, BasicCodeLocation
from mlidea.analysis._analysis_utils import find_nodes_by_type, get_columns_used_as_feature
from mlidea.analysis._cleaning_methods import MissingValueCleaner, DuplicateCleaner, OutlierCleaner, MislabelCleaner
        ...
        for column, error in self._columns_with_error:
            for cleaning_method in CLEANING_METHODS_FOR_ERROR_TYPE[error]:
                ...
                if cleaning_method.patch_type == PatchType.DATA_FILTER_PATCH:
                    ...
                    raise NotImplementedError(f"Unknown patch type: {cleaning_method.patch_type}!")
