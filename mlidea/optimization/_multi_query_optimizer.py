...
from mlidea.optimization._simple_filter_addition_push_up import SimpleFilterAdditionPushUp
from mlidea.optimization._simple_projection_push_up import SimpleProjectionPushUp
from mlidea.optimization._udf_split_and_reuse import UdfSplitAndReuse
...
class MultiQueryOptimizer:
    ...
    def _optimize_and_combine_dags(self, analysis_results: AnalysisResults, skip_optimizer):
        ...
        if skip_optimizer is False:
            logger.info("Performing Multi-Query Optimization")
